/* @ts-self-types="./harness_wasm.d.ts" */

/**
 * The bundled default world manifest (YAML) — seeds editors and playgrounds.
 * @returns {string}
 */
export function default_world() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.default_world();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('harness_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
