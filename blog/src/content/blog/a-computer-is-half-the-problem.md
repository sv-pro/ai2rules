...
allowed to do while you're in the room. You need both, and (the part people skip)
...
We were reviewing our own execution layer, the piece that actually runs a shell command
an agent asked for, and found something uncomfortable. On every call, that runner is handed a
