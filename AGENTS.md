...
├── DECISIONS.md              # ADR-lite decision log (D1–D51+)
...
provider-adapters 5 · agent-core 16 · harness-preview 45 · cli-harness 64 ·
harness-wasm 0 · **total 228** (plus the harness-wasm Node smoke tests, run via
wasm-pack)
...
- **Record architectural decisions in `DECISIONS.md`.** When a choice closes off
  ...
  can be revisited later. Currently D1–D51.
...
| `DECISIONS.md` | ADR-lite log D1–D51+; consult before choosing alternatives |
