...
├── DECISIONS.md              # ADR-lite decision log (D1–D50+)
...
provider-adapters 5 · agent-core 16 · harness-preview 45 · cli-harness 61 ·
harness-wasm 0 · **total 225** (plus the harness-wasm Node smoke tests, run via
wasm-pack)
...
- **Record architectural decisions in `DECISIONS.md`.** When a choice closes off
  ...
  can be revisited later. Currently D1–D50.
...
| `DECISIONS.md` | ADR-lite log D1–D50+; consult before choosing alternatives |
